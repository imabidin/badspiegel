...
document.addEventListener("DOMContentLoaded", () => {
   ...
   * Values X Container
   */
  dependenciesValuesXcontainer("tueren", value => value === "1x", "tuer_anschlagrichtung");
  dependenciesValuesXcontainer(
    "tueren",
    value => value === "2x" || value === "3x" || value === "4x" || value === "5x" || value === "6x",
  ...
  dependenciesValuesXcontainer(
    "tueren",
    value => value === "3x" || value === "4x" || value === "5x" || value === "6x",
  ...
  dependenciesValuesXcontainer("tueren", value => value === "5x" || value === "6x", "tuer_5_anschlagrichtung");
  dependenciesValuesXcontainer("tueren", value => value === "6x", "tuer_6_anschlagrichtung");
