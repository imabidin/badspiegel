  ...
  var updateInputState = function updateInputState(input, isValid) {
    ...
    if (triggerChange) {
      ...
      if (updateBtn && !updateBtn.disabled) {
        ...
        updateBtn.updateTimeout = setTimeout(function () {
          try {
            updateBtn.click();
          } catch (error) {
...
var CONFIG = {
  ...
  // 10 seconds timeout (consistent with comment)
...
var timeoutIds = new Set(); // Track all timeouts for cleanup
 ...
 */
document.addEventListener("DOMContentLoaded", function () {
  var wooEvents = ["updated_wc_div", "updated_cart_totals", "wc_fragments_refreshed"];
  wooEvents.forEach(function (eventName) {
    document.body.addEventListener(eventName, function () {
      debug("WooCommerce ".concat(eventName, " detected, re-initializing"));
      initCheckoutSpinner();
    });
  });
});
