...
document.addEventListener("DOMContentLoaded", function () {
   ...
   */
  var paypalContainer = document.querySelector("[data-pp-message]");
   ...
   * @type {HTMLElement|null}
   */
  var priceContainer = document.querySelector(".woocommerce-Price-amount.amount");
   ...
   * @type {HTMLElement|null}
   */
  var price = priceContainer.querySelector("bdi");
  ...
  var updatePrice = function updatePrice() {
     ...
     */
    var integer = function (_price$textContent$tr) {
      var m = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (_price$textContent$tr = price.textContent.trim().match(/(\d+,\d+)/)) === null || _price$textContent$tr === void 0 ? void 0 : _price$textContent$tr[1];
      return m ? parseFloat(m.replace(",", ".")).toString() : null;
    }();
...
/* harmony import */ var _js_product_paypal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/product/paypal.js */ "./assets/js/product/paypal.js");
// product.js
