...
// Key: hochschrank-BHS006
// File: hochschrank-BHS006.php
//
// ---- Kontrollpreise ----
// S21 = (CSV-Preis + MwSt) + S21-Aufschlag + Versand
// BSD = round(S21-Preis * BSD-Marge)
// Basispreis (wird abgezogen): 191 (gerundet von 190.98 für 200x400)
// Endpreis = BSD - Basispreis
// ------------------------
// 200x200:
//   S21-Preis: 190.98
//   BSD-Preis: 191 (gerundet von 190.98)
//   Endpreis: 0
// ------------------------
// 400x400:
//   S21-Preis: 190.98
...
// 800x600:
//   S21-Preis: 603.68
//   BSD-Preis: 604 (gerundet von 603.68)
//   Endpreis: 413
// ------------------------
// 1200x800:
//   S21-Preis: 696.08
//   BSD-Preis: 696 (gerundet von 696.08)
//   Endpreis: 505
// ------------------------
// 2500x1500:
//   S21-Preis: 1864.20
//   BSD-Preis: 1864 (gerundet von 1864.20)
//   Endpreis: 1673
// ------------------------
//
// ============================================================
...
return array(
    'hochschrank-BHS006' => array(
        ...
        'options' => array(
            ...
            '500x1600' => array('label' => '500mm x 1600mm', 'price' => 587),
