...
// Key: lowsideboard-021A1
// File: lowsideboard-021A1.php
//
// ---- Kontrollpreise ----
// S21 = (CSV-Preis + MwSt) + S21-Aufschlag + Versand
// BSD = round(S21-Preis * BSD-Marge)
// Basispreis (wird abgezogen): 968 (gerundet von 967.61 für 1050x400)
// Endpreis = BSD - Basispreis
// ------------------------
// 200x200:
//   S21-Preis: 882.28
//   BSD-Preis: 882 (gerundet von 882.28)
//   Endpreis: -86
// ------------------------
// 400x400:
//   S21-Preis: 948.71
//   BSD-Preis: 949 (gerundet von 948.71)
//   Endpreis: -19
// ------------------------
// 800x600:
//   S21-Preis: 968.31
//   BSD-Preis: 968 (gerundet von 968.31)
//   Endpreis: 0
// ------------------------
// 1200x800:
//   S21-Preis: 987.91
//   BSD-Preis: 988 (gerundet von 987.91)
//   Endpreis: 20
// ------------------------
// 2500x1500:
//   S21-Preis: 1053.62
//   BSD-Preis: 1054 (gerundet von 1053.62)
//   Endpreis: 86
// ------------------------
//
// ============================================================
...
return array(
    'lowsideboard-021A1' => array(
        ...
        'options' => array(
            ...
            '1150x500' => array('label' => '1150mm x 500mm', 'price' => 6),
            '1150x600' => array('label' => '1150mm x 600mm', 'price' => 10),
            '1150x700' => array('label' => '1150mm x 700mm', 'price' => 14),
            '1150x800' => array('label' => '1150mm x 800mm', 'price' => 18),
            '1250x400' => array('label' => '1250mm x 400mm', 'price' => 5),
            '1250x500' => array('label' => '1250mm x 500mm', 'price' => 9),
            '1250x600' => array('label' => '1250mm x 600mm', 'price' => 13),
            ...
            '2250x500' => array('label' => '2250mm x 500mm', 'price' => 38),
            '2250x600' => array('label' => '2250mm x 600mm', 'price' => 42),
            '2250x700' => array('label' => '2250mm x 700mm', 'price' => 46),
            '2250x800' => array('label' => '2250mm x 800mm', 'price' => 50),
            '2350x400' => array('label' => '2350mm x 400mm', 'price' => 37),
            '2350x500' => array('label' => '2350mm x 500mm', 'price' => 41),
