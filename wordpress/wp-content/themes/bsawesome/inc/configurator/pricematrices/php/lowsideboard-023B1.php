...
// Key: lowsideboard-023B1
// File: lowsideboard-023B1.php
//
// ---- Kontrollpreise ----
// S21 = (CSV-Preis + MwSt) + S21-Aufschlag + Versand
// BSD = round(S21-Preis * BSD-Marge)
// Basispreis (wird abgezogen): 788 (gerundet von 787.91 für 1050x400)
// Endpreis = BSD - Basispreis
// ------------------------
// 200x200:
//   S21-Preis: 702.58
//   BSD-Preis: 703 (gerundet von 702.58)
//   Endpreis: -85
// ------------------------
// 400x400:
//   S21-Preis: 769.01
//   BSD-Preis: 769 (gerundet von 769.01)
//   Endpreis: -19
// ------------------------
// 800x600:
//   S21-Preis: 788.61
//   BSD-Preis: 789 (gerundet von 788.61)
//   Endpreis: 1
// ------------------------
// 1200x800:
//   S21-Preis: 808.21
//   BSD-Preis: 808 (gerundet von 808.21)
//   Endpreis: 20
// ------------------------
// 2500x1500:
//   S21-Preis: 873.92
//   BSD-Preis: 874 (gerundet von 873.92)
//   Endpreis: 86
// ------------------------
//
// ============================================================
...
return array(
    'lowsideboard-023B1' => array(
        ...
        'options' => array(
            ...
            '1250x700' => array('label' => '1250mm x 700mm', 'price' => 18),
            '1250x800' => array('label' => '1250mm x 800mm', 'price' => 22),
            '1350x400' => array('label' => '1350mm x 400mm', 'price' => 9),
            '1350x500' => array('label' => '1350mm x 500mm', 'price' => 13),
            '1350x600' => array('label' => '1350mm x 600mm', 'price' => 17),
            '1350x700' => array('label' => '1350mm x 700mm', 'price' => 21),
            '1350x800' => array('label' => '1350mm x 800mm', 'price' => 25),
            '1450x400' => array('label' => '1450mm x 400mm', 'price' => 12),
            '1450x500' => array('label' => '1450mm x 500mm', 'price' => 16),
            '1450x600' => array('label' => '1450mm x 600mm', 'price' => 20),
            ...
            '2350x600' => array('label' => '2350mm x 600mm', 'price' => 46),
            '2350x700' => array('label' => '2350mm x 700mm', 'price' => 50),
            '2350x800' => array('label' => '2350mm x 800mm', 'price' => 54),
            '2450x400' => array('label' => '2450mm x 400mm', 'price' => 41),
            '2450x500' => array('label' => '2450mm x 500mm', 'price' => 45),
            '2450x600' => array('label' => '2450mm x 600mm', 'price' => 49),
            '2450x700' => array('label' => '2450mm x 700mm', 'price' => 53),
            '2450x800' => array('label' => '2450mm x 800mm', 'price' => 57),
        ),
    ),
);