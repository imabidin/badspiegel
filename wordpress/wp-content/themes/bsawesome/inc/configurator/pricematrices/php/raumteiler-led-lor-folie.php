...
// Key: raumteiler-led-lor-folie
// File: raumteiler-led-lor-folie.php
//
// ---- Kontrollpreise ----
// S21 = (CSV-Preis + MwSt) + S21-Aufschlag + Versand
// BSD = round(S21-Preis * BSD-Marge)
// Basispreis (wird abgezogen): 278 (gerundet von 277.98 für 500x500)
...
// 400x400:
//   S21-Preis: 199.98
//   BSD-Preis: 200 (gerundet von 199.98)
//   Endpreis: -78
// ------------------------
// 800x600:
//   S21-Preis: 402.93
//   BSD-Preis: 403 (gerundet von 402.93)
//   Endpreis: 125
// ------------------------
// 1200x800:
//   S21-Preis: 558.59
//   BSD-Preis: 559 (gerundet von 558.59)
//   Endpreis: 281
// ------------------------
// 2500x1500:
//   S21-Preis: 1150.84
//   BSD-Preis: 1151 (gerundet von 1150.84)
//   Endpreis: 873
// ------------------------
//
// ============================================================
...
return array(
    'raumteiler-led-lor-folie' => array(
        'key' => 'raumteiler-led-lor-folie',
        'order' => 30,
        'group' => 'masse',
        'label' => 'Aufpreis Breite und Höhe',
