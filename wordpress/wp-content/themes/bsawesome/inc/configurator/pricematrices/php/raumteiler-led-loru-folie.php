...
// Key: raumteiler-led-loru-folie
// File: raumteiler-led-loru-folie.php
//
// ---- Kontrollpreise ----
// S21 = (CSV-Preis + MwSt) + S21-Aufschlag + Versand
// BSD = round(S21-Preis * BSD-Marge)
// Basispreis (wird abgezogen): 280 (gerundet von 279.98 für 500x500)
...
// 400x400:
//   S21-Preis: 201.98
//   BSD-Preis: 202 (gerundet von 201.98)
//   Endpreis: -78
// ------------------------
// 800x600:
//   S21-Preis: 404.93
//   BSD-Preis: 405 (gerundet von 404.93)
//   Endpreis: 125
// ------------------------
// 1200x800:
//   S21-Preis: 560.59
//   BSD-Preis: 561 (gerundet von 560.59)
//   Endpreis: 281
// ------------------------
// 2500x1500:
//   S21-Preis: 1152.84
//   BSD-Preis: 1153 (gerundet von 1152.84)
//   Endpreis: 873
// ------------------------
//
// ============================================================
...
return array(
    'raumteiler-led-loru-folie' => array(
        'key' => 'raumteiler-led-loru-folie',
        'order' => 30,
        'group' => 'masse',
        'label' => 'Aufpreis Breite und Höhe',
