...
// Key: raumteiler-led-lr-folie
// File: raumteiler-led-lr-folie.php
//
// ---- Kontrollpreise ----
// S21 = (CSV-Preis + MwSt) + S21-Aufschlag + Versand
// BSD = round(S21-Preis * BSD-Marge)
// Basispreis (wird abgezogen): 248 (gerundet von 248.48 für 500x400)
...
// 400x400:
//   S21-Preis: 194.98
//   BSD-Preis: 195 (gerundet von 194.98)
//   Endpreis: -53
// ------------------------
// 800x600:
//   S21-Preis: 397.93
//   BSD-Preis: 398 (gerundet von 397.93)
//   Endpreis: 150
// ------------------------
// 1200x800:
//   S21-Preis: 553.59
//   BSD-Preis: 554 (gerundet von 553.59)
//   Endpreis: 306
// ------------------------
// 2500x1500:
//   S21-Preis: 1145.84
//   BSD-Preis: 1146 (gerundet von 1145.84)
//   Endpreis: 898
// ------------------------
//
// ============================================================
...
// Matrix Statistics:
// Total Entries: 126
// Size Range: 500x400 - 1800x1200
// Price Range: €0 - €569
// ============================================================

// Generated price matrix
return array(
    'raumteiler-led-lr-folie' => array(
        'key' => 'raumteiler-led-lr-folie',
        'order' => 30,
        'group' => 'masse',
        'label' => 'Aufpreis Breite und Höhe',
        'options' => array(
            ...
            '600x400' => array('label' => '600mm x 400mm', 'price' => 25),
            ...
            '700x400' => array('label' => '700mm x 400mm', 'price' => 49),
            ...
            '1000x400' => array('label' => '1000mm x 400mm', 'price' => 123),
            ...
            '1300x400' => array('label' => '1300mm x 400mm', 'price' => 198),
            ...
            '1400x400' => array('label' => '1400mm x 400mm', 'price' => 223),
            ...
            '1500x400' => array('label' => '1500mm x 400mm', 'price' => 248),
            ...
            '1600x400' => array('label' => '1600mm x 400mm', 'price' => 273),
            ...
            '1700x400' => array('label' => '1700mm x 400mm', 'price' => 299),
            ...
            '1800x400' => array('label' => '1800mm x 400mm', 'price' => 324),
