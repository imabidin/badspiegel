...
// Key: unterschrank-BMAR010A-LED
// File: unterschrank-BMAR010A-LED.php
//
// ---- Kontrollpreise ----
// S21 = (CSV-Preis + MwSt) + S21-Aufschlag + Versand
// BSD = round(S21-Preis * BSD-Marge)
// Basispreis (wird abgezogen): 475 (gerundet von 475.48 für 300x300)
...
// 400x400:
//   S21-Preis: 599.61
//   BSD-Preis: 600 (gerundet von 599.61)
//   Endpreis: 125
// ------------------------
// 800x600:
//   S21-Preis: 794.86
//   BSD-Preis: 795 (gerundet von 794.86)
//   Endpreis: 320
// ------------------------
// 1200x800:
//   S21-Preis: 913.35
//   BSD-Preis: 913 (gerundet von 913.35)
//   Endpreis: 438
// ------------------------
...
return array(
    'unterschrank-BMAR010A-LED' => array(
        'key' => 'unterschrank-BMAR010A-LED',
        'order' => 30,
        'group' => 'masse',
        'label' => 'Aufpreis Breite und Höhe',
        'options' => array(
            ...
            '300x500' => array('label' => '300mm x 500mm', 'price' => 190),
            ...
            '800x800' => array('label' => '800mm x 800mm', 'price' => 344),
            ...
            '900x600' => array('label' => '900mm x 600mm', 'price' => 344),
            ...
            '1000x400' => array('label' => '1000mm x 400mm', 'price' => 344),
