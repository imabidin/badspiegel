...
// Key: unterschrank-BMAR019A
// File: unterschrank-BMAR019A.php
//
// ---- Kontrollpreise ----
// S21 = (CSV-Preis + MwSt) + S21-Aufschlag + Versand
// BSD = round(S21-Preis * BSD-Marge)
// Basispreis (wird abgezogen): 645 (gerundet von 644.96 für 600x250)
...
// 400x400:
//   S21-Preis: 533.19
//   BSD-Preis: 533 (gerundet von 533.19)
//   Endpreis: -112
// ------------------------
// 800x600:
//   S21-Preis: 742.71
//   BSD-Preis: 743 (gerundet von 742.71)
//   Endpreis: 98
// ------------------------
// 1200x800:
//   S21-Preis: 873.05
//   BSD-Preis: 873 (gerundet von 873.05)
//   Endpreis: 228
// ------------------------
...
return array(
    'unterschrank-BMAR019A' => array(
        ...
        'options' => array(
            ...
            '1300x550' => array('label' => '1300mm x 550mm', 'price' => 222),
            '1400x250' => array('label' => '1400mm x 250mm', 'price' => 208),
            '1400x350' => array('label' => '1400mm x 350mm', 'price' => 222),
            '1400x450' => array('label' => '1400mm x 450mm', 'price' => 235),
            '1400x550' => array('label' => '1400mm x 550mm', 'price' => 248),
            '1500x250' => array('label' => '1500mm x 250mm', 'price' => 235),
            '1500x350' => array('label' => '1500mm x 350mm', 'price' => 248),
