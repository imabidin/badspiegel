<?php
/**
 * The Template for displaying the SEPA checkbox.
 *
 * This template can be overridden by copying it to yourtheme/woocommerce-germanized/checkout/terms-sepa.php.
 *
