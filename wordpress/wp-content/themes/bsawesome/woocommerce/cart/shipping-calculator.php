	...
	<section class="shipping-calculator-form" id="shipping-calculator-form" style="display:none;">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_state', true ) ) : ?>
			<p class="form-row form-row-wide" id="calc_shipping_state_field">
				...
				if ( is_array( $states ) && empty( $states ) ) {
					...
					?>
					<span>
						<label for="calc_shipping_state" class="visually-hidden-focusable"><?php esc_html_e( 'State / County:', 'woocommerce' ); ?></label>
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_city', true ) ) : ?>
			<p class="form-row form-row-wide" id="calc_shipping_city_field">
				<label for="calc_shipping_city" class="visually-hidden-focusable"><?php esc_html_e( 'City:', 'woocommerce' ); ?></label>
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
			<p class="form-row form-row-wide" id="calc_shipping_postcode_field">
				<label for="calc_shipping_postcode" class="visually-hidden-focusable"><?php esc_html_e( 'Postcode / ZIP:', 'woocommerce' ); ?></label>
		...
		<button type="submit" name="calc_shipping" value="1" class="button btn btn-dark"><?php esc_html_e( 'Update', 'woocommerce' ); ?></button>
