...
<div class="woocommerce-billing-fields">
	<?php if (wc_ship_to_billing_address_only() && WC()->cart->needs_shipping()) : ?>
		...
		<h3 id="customer_details_heading"><?php esc_html_e('Billing &amp; Shipping', 'woocommerce'); ?></h3>
		...
		<?php if (! $checkout->is_registration_required()) : ?>
			...
			<p class="form-row form-row-wide create-account">
				<span class="form-check">
					...
					<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox form-check-label" for="createaccount"><?php esc_html_e('Create an account?', 'woocommerce'); ?></label>
				</span>
			</p>
