...
<div id="payment" class="woocommerce-checkout-payment bg-light px-2 py-1 mb">
	...
	<div class="form-row place-order">
		<noscript>
			...
			?>
			<br /><button type="submit" class="button alt w-100 btn btn-lg btn-primary fw-medium btn btn-dark" name="woocommerce_checkout_update_totals" value="<?php esc_attr_e('Update totals', 'woocommerce'); ?>"><?php esc_html_e('Update totals', 'woocommerce'); ?></button>
		</noscript>
