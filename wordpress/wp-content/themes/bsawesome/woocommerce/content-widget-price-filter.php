...
<form method="get" action="<?php echo esc_url( $form_action ); ?>">
	<div class="price_slider_wrapper">
		...
		<div class="price_slider_amount" data-step="<?php echo esc_attr( $step ); ?>">
			<label class="visually-hidden-focusable" for="min_price"><?php esc_html_e( 'Min price', 'woocommerce' ); ?></label>
			...
			<label class="visually-hidden-focusable" for="max_price"><?php esc_html_e( 'Max price', 'woocommerce' ); ?></label>
			...
			<button type="submit" class="button btn btn-dark"><?php echo esc_html__( 'Filter', 'woocommerce' ); ?></button>
