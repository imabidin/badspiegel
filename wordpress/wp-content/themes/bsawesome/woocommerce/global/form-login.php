...
<form class="woocommerce-form woocommerce-form-login login" method="post" <?php echo ($hidden) ? 'style="display:none;"' : ''; ?>>
	...
	<p class="form-row form-row-first">
		<label class="form-label" for="username"><?php esc_html_e('Username or email', 'woocommerce'); ?>&nbsp;<span class="required" aria-hidden="true">*</span><span class="visually-hidden-focusable"><?php esc_html_e('Required', 'woocommerce'); ?></span></label>
	...
	<p class="form-row form-row-last">
		<label class="form-label" for="password"><?php esc_html_e('Password', 'woocommerce'); ?>&nbsp;<span class="required" aria-hidden="true">*</span><span class="visually-hidden-focusable"><?php esc_html_e('Required', 'woocommerce'); ?></span></label>
	...
	<p class="form-row">
		...
		<button type="submit" class="woocommerce-button button woocommerce-form-login__submit btn btn-dark" name="login" value="<?php esc_attr_e('Login', 'woocommerce'); ?>"><?php esc_html_e('Login', 'woocommerce'); ?></button>
	</p>
