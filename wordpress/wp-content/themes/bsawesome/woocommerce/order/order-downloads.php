...
<section class="woocommerce-order-downloads">
	...
	<table class="woocommerce-table woocommerce-table--order-downloads table table-light shop_table shadow-sm table shop_table_responsive order_details" style="--bs-table-border-color: var(--bs-body-bg);">
		<thead>
			<tr>
						...
						if (has_action('woocommerce_account_downloads_column_' . $column_id)) {
							...
							switch ($column_id) {
								case 'download-product':
									...
									break;
								case 'download-file':
									echo '<a href="' . esc_url($download['download_url']) . '" class="woocommerce-MyAccount-downloads-file button alt w-100 btn btn-lg btn-primary fw-medium">' . esc_html($download['download_name']) . '</a>';
									break;
